...
//Can't seem to get this one to work, I need some help!!!
...
function each(array,callback){
  for(let i = 0;i<array.length;i++){
    callback(name,array[i])
  }
}

// Do not edit the code below.
each(names, function(item, index){
  console.log('The item in the ' + index + ' position is ' + item)//you made typos, "indice" should be "index"
});
// Do not edit the code above.
